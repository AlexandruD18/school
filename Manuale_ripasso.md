...
&nbsp; `=FREQUENZA(tabella; estremo\_sup)`  

\- \*\*Totale frequenze assolute:\*\* somma di tutte le frequenze.  

\- \*\*Frequenza relativa:\*\*  

&nbsp; `=frequenza\_assoluta / totale\_frequenze`  
...
&nbsp; `=frequenza\_cumulata\_assoluta / totale\_frequenze`
...
&nbsp;  - Tipo 1 → `=valore\_1\_N\_GUASTI / totale\_N\_GUASTI`  

&nbsp;  - Tipo 2 → `=valore\_2\_N\_GUASTI / totale\_N\_GUASTI`  

&nbsp;  - Tipo 3 → `=valore\_3\_N\_GUASTI / totale\_N\_GUASTI`  
